...
export const StaffManagement: React.FC = () => {
    ...
    const confirmResetPassword = async () => {
        ...
        try {
            ...
            console.log("[Reset Password] payload:", res.data); // Log API response for debugging
            const pwd = res?.data?.password ?? res?.data?.data?.password;
            if (pwd) {
                setPwValue(pwd);
            ...
            {tab === 0 && (
                <Box>
                    ...
                    <Dialog open={pwDialogOpen} onClose={() => setPwDialogOpen(false)} fullWidth maxWidth="xs">
                        ...
                        <DialogContent>
                            ...
                            <Typography variant="caption" sx={{ mt: 1, display: "block", color: "text.secondary" }}>
                                Keep this password safe. It’s only shown once. Use “Reset Password” later to generate a new one.
                            </Typography>
                        </DialogContent>
                    ...
                    <Dialog open={confirmResetDialogOpen} onClose={() => setConfirmResetDialogOpen(false)} fullWidth maxWidth="xs">
                        ...
                        <DialogActions>
                            <Button onClick={() => { setConfirmResetDialogOpen(false); setStaffToReset(null); }} sx={{ textTransform: "none" }}>
                                Cancel
                            </Button>
