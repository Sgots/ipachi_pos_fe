...
const Reports: React.FC = () => {
    ...
    const loadAll = async () => {
        ...
        try {
            ...
            // === Include Cash-Up when Cash Up OR Comprehensive
            ...
            // === Include Trade Account when Trade Account Statement OR Comprehensive
    ...
    // ======= NEW: Export PDF of the entire main content (excluding sidebar) =======
    ...
    const exportPDF = async () => {
        ...
        const [{ default: html2canvas }, { default: jsPDFModule }] = await Promise.all([
            import("html2canvas"),
            import("jspdf") as any,
        ]);
        // jsPDF default export can vary; normalize
        const jsPDF = (jsPDFModule as any).jsPDF ?? jsPDFModule.jsPDF ?? jsPDFModule;

        // Render full height of the content area
        ...
        // Add more pages as needed by shifting the image up
        while (heightLeft > 0) {
            pdf.addPage();
    ...
    return (
        // Wrap ONLY the main content so sidebar is excluded from capture
        <Box ref={contentRef} sx={{ p: 3, bgcolor: '#f5f5f5' }}>
            ...
            <Paper sx={{ p: 2, mb: 3, borderRadius: 2, boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs />
                    <Grid item xs={12} md="auto" data-html2canvas-ignore>
                        <Button
                            variant="contained"
            ...
            <Paper sx={{ p: 2, mb: 3, borderRadius: 2, boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                <Grid container spacing={2} alignItems="center">
                    {[
                        ...
                        { label: "Total Sales", value: `BWP ${fmtMoney(kpis.totalSales)}`, unit: "" },
                        { label: "Overall Profit", value: `BWP ${fmtMoney(kpis.overallProfit)}`, unit: "" },
